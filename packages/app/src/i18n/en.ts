export const dict = {
  ...
  "settings.general.row.uiFont.description": "Customise the font used in the interface",
  "settings.general.row.uiFontSize.title": "UI Font Size",
  "settings.general.row.uiFontSize.description": "Adjust the size of UI text",
  "settings.general.row.uiLineHeight.title": "UI Line Height",
  "settings.general.row.uiLineHeight.description": "Adjust the line spacing of UI text",
  "settings.general.row.uiLetterSpacing.title": "UI Letter Spacing",
  "settings.general.row.uiLetterSpacing.description": "Adjust the letter spacing of UI text",
  "settings.general.row.containerWidth.title": "Editor Width",
  "settings.general.row.containerWidth.description": "Adjust the maximum width of the editor container",
  ...
  "font.option.akkuratMono": "Akkurat Mono",
  "font.option.usb": "USB",
  "font.option.inter": "Inter",
  "font.option.systemSans": "System Sans",
  "font.option.systemSerif": "System Serif",
